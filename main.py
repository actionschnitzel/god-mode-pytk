...
class MainApplication(tk.Tk):
    def __init__(self):
        ...
        self.brave_icon = PhotoImage(
                file="icons/cute_tux.png")
        ...
        distribution_info = get_linux_distribution_info()
        ...
        desktop_launcher_path = os.path.expanduser("~/.local/share/applications/steam.desktop")
        ...
        self.hadder = Label(self.main_frame,compound=TOP,text="Not Your Mommy Edition (Learn Terminal!)",image=self.brave_icon, background="#09928B",foreground="#FFFFFF")
        self.hadder.pack()

        self.syscore = LabelFrame(self.main_frame,text="System CheckUp",font=("Sans",12),padx=20,pady=20, background="#FFFFFF" ,borderwidth=0,highlightthickness=0)
        ...
        self.surface_core = LabelFrame(self.main_frame,text="Installers",font=("Sans",12),pady=5,padx=5, background="#FFFFFF",borderwidth=0,highlightthickness=0)
        ...
        for surf_button in surface_button_list:
            ...
            if surf_button == "Steam" and os.path.exists(desktop_launcher_path) == True:
                print("Bla")
                #self.surface_button_x.config(state=DISABLED)
            if surf_button == "Flatpak Support" and os.path.exists(flatpak_path) == True:
                print("Bla")
                #self.surface_button_x.config(state=DISABLED)
        ...
        if distribution_info:
            ...
            self.your_distro.configure(text=f"Debian Codename: {distribution_info.get('DEBIAN_CODENAME', 'N/A')}")
            self.your_distro_full.configure(text=f"Full Name: {distribution_info.get('PRETTY_NAME', 'N/A')}")

            distro_id = distribution_info.get('ID', '').lower()
            if distro_id in ['debian', 'ubuntu', 'linuxmint', 'lmde', 'pop']:
                print(f"Your Linux distribution is based on Debian: {distro_id.capitalize()}")
            else:
        ...
        if os.path.exists(lutris_directory):
            ...
            self.lutris_i.configure(text=f"Lutris: Not Installed")




        # Define the path to the directory you want to check
        directory_path = os.path.expanduser("~/.var/app/com.heroicgameslauncher.hgl")
        ...
        if os.path.exists(directory_path):
            ...
            self.heroic_i.configure(text=f"Heroic Games Launcher: Not Installed (Needs Flatpak)")
        ...
        if check_nvidia_gpu():
            ...
            self.graka.configure(text="Driver: You are not using an NVIDIA graphics card")
...
class Nvidia_Top(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.nv_deb = LabelFrame(self,text="Debian",font=("Sans",12),padx=20,pady=20, background="#FFFFFF" ,borderwidth=0,highlightthickness=0)
        self.nv_deb.pack(pady=20,padx=20, fill="x", expand=True)

        self.deb_ent_0 = Entry(self.nv_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_0.pack(pady=1,padx=5, fill="x")
        self.deb_ent_0.insert(0,f"sudo apt install linux-headers-amd64")

        self.deb_ent_1 = Entry(self.nv_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_1.pack(pady=1,padx=5, fill="x")
        self.deb_ent_1.insert(0,f"deb http://deb.debian.org/debian/ {distribution_info.get('DEBIAN_CODENAME', 'N/A')} main contrib non-free non-free-firmware #Add to:/etc/apt/sources.list")

        self.deb_ent_2 = Entry(self.nv_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_2.pack(pady=1,padx=5, fill="x")
        self.deb_ent_2.insert(0,f"sudo apt update")

        self.deb_ent_2 = Entry(self.nv_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_2.pack(pady=1,padx=5, fill="x")
        self.deb_ent_2.insert(0,f"sudo apt install nvidia-driver firmware-misc-nonfree")


        self.nv_inst_btn = Button(self,text="Give Me A Terminal",borderwidth=0,highlightthickness=1, command=gimme_term)
...
class Lutris_Top(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.lutris_info = Label (self, text="This will kick-off a Lutris Terminal Install", bg="#09928B",fg="#FFFFFF")
        self.lutris_info.pack(pady=20)

        self.lu_inst_btn = Button(self,text="Do it!",borderwidth=0,highlightthickness=0,command=install_lutris_deb)
...
steam"""
        ...
        self.steam_info = Label (self, text="This will kick-off a Steam Terminal Install", bg="#09928B",fg="#FFFFFF")
        self.steam_info.pack(pady=20)

        self.st_inst_btn = Button(self,text="Do it!",borderwidth=0,highlightthickness=0,command=install_steam_deb)
...
class Heroic_Top(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.heroic_info = Label (self, text="This will kick-off a Heroic Terminal Install", bg="#09928B",fg="#FFFFFF")
        self.heroic_info.pack(pady=20)

        self.lu_inst_btn = Button(self,text="Do it!",borderwidth=0,highlightthickness=0,command=install_heroic_deb)
        self.lu_inst_btn.pack()
...
class Wine_Top(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.wine_deb = LabelFrame(self,text="Debian",font=("Sans",12),padx=20,pady=20, background="#FFFFFF" ,borderwidth=0,highlightthickness=0)
        self.wine_deb.pack(pady=20,padx=20, fill="x", expand=True)

        self.deb_ent_0 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_0.pack(pady=1,padx=5, fill="x")
        self.deb_ent_0.insert(1,f"sudo dpkg --add-architecture i386")

        self.deb_ent_1 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_1.pack(pady=1,padx=5, fill="x")
        self.deb_ent_1.insert(0,"sudo mkdir -pm755 /etc/apt/keyrings")

        self.deb_ent_2 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_2.pack(pady=1,padx=5, fill="x")
        self.deb_ent_2.insert(0,"sudo wget -O /etc/apt/keyrings/winehq-archive.key https://dl.winehq.org/wine-builds/winehq.key")

        self.deb_ent_3 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_3.pack(pady=1,padx=5, fill="x")
        self.deb_ent_3.insert(0,f"sudo wget -NP /etc/apt/sources.list.d/ https://dl.winehq.org/wine-builds/debian/dists/{distribution_info.get('DEBIAN_CODENAME', 'N/A')}/winehq-{distribution_info.get('DEBIAN_CODENAME', 'N/A')}.sources")

        self.deb_ent_3 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_3.pack(pady=1,padx=5, fill="x")
        self.deb_ent_3.insert(0,f"sudo apt update")

        self.deb_ent_4 = Entry(self.wine_deb, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.deb_ent_4.pack(pady=1,padx=5, fill="x")
        self.deb_ent_4.insert(0,f"sudo apt install --install-recommends winehq-stable")



        self.wine_ub = LabelFrame(self,text="Ubuntu Base",font=("Sans",12),padx=20,pady=20, background="#FFFFFF" ,borderwidth=0,highlightthickness=0)
        self.wine_ub.pack(pady=20,padx=20, fill="x", expand=True)

        self.ubuntu_ent_0 = Entry(self.wine_ub, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.ubuntu_ent_0.pack(pady=1,padx=5, fill="x")
        self.ubuntu_ent_0.insert(0,f"sudo dpkg --add-architecture i386")

        self.ubuntu_ent_1 = Entry(self.wine_ub, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.ubuntu_ent_1.pack(pady=1,padx=5, fill="x")
        self.ubuntu_ent_1.insert(0,"sudo mkdir -pm755 /etc/apt/keyrings")

        self.ubuntu_ent_2 = Entry(self.wine_ub, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.ubuntu_ent_2.pack(pady=1,padx=5, fill="x")
        self.ubuntu_ent_2.insert(0,"sudo wget -O /etc/apt/keyrings/winehq-archive.key https://dl.winehq.org/wine-builds/winehq.key")

        self.ubuntu_ent_3 = Entry(self.wine_ub, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.ubuntu_ent_3.pack(pady=1,padx=5, fill="x")
        self.ubuntu_ent_3.insert(0,f"sudo wget -NP /etc/apt/sources.list.d/ https://dl.winehq.org/wine-builds/ubuntu/dists/{distribution_info.get('VERSION_CODENAME', 'N/A')}/winehq-{distribution_info.get('VERSION_CODENAME', 'N/A')}.sources"
)
        ...
        self.ubuntu_ent_4 = Entry(self.wine_ub, background="#FFFFFF" ,borderwidth=0,highlightthickness=1)
        self.ubuntu_ent_4.pack(pady=1,padx=5, fill="x")
        self.ubuntu_ent_4.insert(0,f"sudo apt install --install-recommends winehq-stable")
        ...
        self.wine_inst_btn = Button(self,text="Give Me A Terminal",borderwidth=0,highlightthickness=0, command=gimme_term)
